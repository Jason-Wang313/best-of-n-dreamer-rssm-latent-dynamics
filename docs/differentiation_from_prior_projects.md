...
- Compared with generic latent planning papers, this repo centers the selected high-score tail induced by candidate-budget sampling.
- Compared with WAM work, only the finite abstract selected-tail estimator is reused.
