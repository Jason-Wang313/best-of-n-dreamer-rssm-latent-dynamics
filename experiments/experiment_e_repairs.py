...
def run(smoke: bool = False, seed: int = 4):
    ...
    write_json(root / "results" / "experiment_e_repairs.json", summary)
    plot_curve(
        rows,
        root / "figures" / "figure2_repair_comparison.png",
        ["raw_value", "uncertainty_pessimism", "belief_consistency", "decoder_consistency", "pilot_calibrated", "combined_repair", "oracle"],
